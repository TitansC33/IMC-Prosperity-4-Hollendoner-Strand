...
class Trader(): 
    ...
    def __init__(self):
        self.POSITION_LIMITS = {
            'ASH_COATED_OSMIUM': 60,           # ULTRA-OPTIMIZED: +1063% vs baseline
        ...
        self.OSMIUM_SPREAD = 4               # ULTRA-OPTIMIZED: tighter spread
        self.OSMIUM_SKEW_FACTOR = 0.2        # shifts quotes 0.2 ticks per unit of inventory

        # Pepper Root
        self.PEPPER_LARGE_ORDER_THRESHOLD = 10  # ULTRA-OPTIMIZED: lower threshold captures more nuance
        self.PEPPER_QUOTE_IMPROVEMENT = 1        # overbid/undercut large MM by 1
        self.PEPPER_SKEW_FACTOR = 0.225          # ULTRA-OPTIMIZED: fine-tuned for max profitability
