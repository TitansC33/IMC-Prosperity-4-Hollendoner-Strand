...
class Trader(): 
    ...
    def __init__(self):
        self.POSITION_LIMITS = {
            'ASH_COATED_OSMIUM': 60,           # OPTIMIZED: +552% improvement
        ...
        self.OSMIUM_SPREAD = 4               # OPTIMIZED: tighter spread (was 5)
        ...
        self.PEPPER_SKEW_FACTOR = 0.25           # OPTIMIZED: reduced from 0.3 for better positioning
